    ...
    for (let i = 0; i < 6; i++) {
        ...
        for (let j = 0; j < 7; j++) {
            ...
            if (i == 0 && j < firstDayOfWeek) {
                calHtml += `<div class='calendar__day'></div>`;
                //     `<div style='background-color:#FFB3BB;' class='calendar__day'>
            ...
            // 0주차 - 첫번째 날
                ...
                calHtml +=
                    `<div style='background-color:#FFE0BB;' class='calendar__day'>
            ...
            // 0주차 - 첫번째 날 이상
                ...
                calHtml +=
                    `<div style='background-color:#FFFFBB' class='calendar__day'>
                        <span>${startDateCount}</span>
                        <span id='${year}${month}${setFixDayCount(startDateCount++)}'></span>
                    </div>`;
            }
            // 1주차 이상 - 마지막 날 이하
                ...
                calHtml +=
                    `<div style='background-color:#BBFFC9;'class='calendar__day'>
                        <span>${startDateCount}</span>
                        <span id='${year}${month}${setFixDayCount(startDateCount++)}'></span>
                    </div>`;
            }
            // 마지막 날 보다 클 경우
                ...
                calHtml += `<div class='calendar__day'></div>`;
                // `<div style='background-color:#B9E1FF;' class='calendar__day'>
