...
prevButton.addEventListener('click', calendarManager.currCalendarDataHandler.bind(this));
nextButton.addEventListener('click', calendarManager.nextCalendarDataHandler);